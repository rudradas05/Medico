...
// //   const { dashData, setDashData, getDashData, doctortoken } =
...
//   const { formatAppointmentDate, currencySymbol } = useContext(AppContext);

//   const [localDashData, setLocalDashData] = useState(null);

//   // State for handling cancellation progress
...
const DoctorDashboard = () => {
  ...
  useEffect(() => {
    setLocalDashData(dashData); // Sync with context data when updated
  }, [dashData]);
