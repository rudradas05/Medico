...
//   return (
//     <div className="p-6 max-w-4xl mx-auto bg-white rounded-3xl shadow-lg border border-gray-50 transition-all duration-300 hover:shadow-xl">
//       {/* Profile Header */}
//       <div className="flex flex-col items-center mb-8">
//         <div className="relative mb-6 group">
...
//         {/* Contact & Basic Info */}
//         <div className="space-y-6">
//           <Section title="Contact Information" icon={assets.contact_icon}>
//             <InfoRow label="Email" value={userData.email} isEmail />
//             <EditableInfo
//               label="Phone"
//               value={userData.phone}
...
//           <Section title="Basic Information" icon={assets.info_icon}>
//             <EditableSelect
//               label="Gender"
//               value={userData.gender}
//               options={["Male", "Female", "Other"]}
...
//         {/* Health Information */}
//         <div className="space-y-6">
//           <Section title="Health Information" icon={assets.health_icon}>
//             <EditableSelect
//               label="Blood Group"
//               value={userData.bloodGroup}
//               options={["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"]}
...
// // Enhanced Reusable Components with better styling
// const Section = ({ title, children, icon }) => (
//   <div className="bg-gradient-to-b from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-gray-100">
//     <div className="flex items-center gap-3 mb-5">
//       <img src={icon} className="w-6 h-6" alt="section icon" />
...
// const InfoRow = ({ label, value, isEmail }) => (
//   <div className="flex justify-between items-center p-3 bg-white rounded-lg shadow-xs hover:bg-gray-50 transition-colors">
...
// const EditableInfo = ({ label, value, isEdit, onChange }) => (
//   <div className="group flex justify-between items-center p-3 bg-white rounded-lg hover:bg-gray-50 transition-colors">
//     <span className="text-sm font-medium text-gray-500">{label}</span>
//     {isEdit ? (
//       <input
//         type="text"
...
// Enhanced EditableInfo with Icons
